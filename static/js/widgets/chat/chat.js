...
(function () {
  ...
  MX.registerWidget("chat", {
    ...
    onFrame(frame, msg) {
      ...
      if (msg.type === "out") streamOut(frame, msg.text);
      else if (msg.type === "meters") setMeters(frame, msg.meters);
      else if (msg.type === "status" && msg.phase === "idle") { c.live = null; c.liveText = ""; }
      else if (msg.type === "speak") speak(frame, msg.text, msg.voice);
